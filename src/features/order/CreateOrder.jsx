  ...
  return (
    <div>
      ...
      <Form method="POST">
        ...
        focus:outline-none focus:ring focus:ring-yellow-500 md:px-6 md:py-2"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <button
            ...
            uppercase tracking-wide text-stone-800 transition-colors duration-300 hover:bg-yellow-300 
